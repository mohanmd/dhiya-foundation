...
var provdLayout =
    Provider.of<LayoutProvider>(materialKey.currentContext!, listen: false);
var provdLeave =
    Provider.of<LeaveProvider>(materialKey.currentContext!, listen: false);
var provdLocation =
    Provider.of<LocationProvider>(materialKey.currentContext!, listen: false);
var provdAuth =
    Provider.of<AuthProvider>(materialKey.currentContext!, listen: false);
var provdPermission =
    Provider.of<PermissionProvider>(materialKey.currentContext!, listen: false);

var provdAttendance =
    Provider.of<AttendanceProvider>(materialKey.currentContext!, listen: false);
var provdCommon =
    Provider.of<CommonProvider>(materialKey.currentContext!, listen: false);
